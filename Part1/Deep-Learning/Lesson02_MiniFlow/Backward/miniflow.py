...
class Linear(Node):
    ...
    def backward(self):
        ...
        for n in self.outbound_nodes:
            ...
            # 为什么grad_cost有的在前，有的在后，因为梯度的传递顺序取决于计算的是相对于输入还是相对于权重的梯度。
            # 简单来说就是矩阵乘法，以及梯度的基本思想
...
class Sigmoid(Node):
    ...
    def backward(self):
        ...
        for n in self.outbound_nodes:
            ...
            # 计算损失函数相对于输入的梯度
            self.gradients[self.inbound_nodes[0]] += grad_cost * sigmoid_derivative
